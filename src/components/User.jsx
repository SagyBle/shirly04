...
import { doc, updateDoc, deleteDoc, getDoc, setDoc, arrayUnion } from "firebase/firestore";
  ...
  return (
    <div>
      <div className='userline'>
        ...
        <p className='para'>{props.user.name}</p>{(uid === props.myuid) && <p> &nbsp;(me)</p>}{(props.user.isAdmin) && <p> &nbsp;(admin)</p>}
      </div>
    </div>
  )
}
